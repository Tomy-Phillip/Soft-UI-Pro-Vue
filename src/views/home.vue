<template>
  <div class="home-container">
    <header data-role="Header" class="home-header">
      ...
      />
      <div class="home-nav">
        <navigation-links rootClassName="rootClassName15"></navigation-links>
      </div>
      ...
      <div data-type="MobileMenu" class="home-mobile-menu">
        <div class="home-nav1">
          ...
          <navigation-links rootClassName="rootClassName16"></navigation-links>
        </div>
        <div>
    ...
    <div class="home-hero">
      <div class="home-container02">
        ...
        <div class="home-container06 parallax"></div>
      </div>
    </div>
    ...
    <section class="home-container07">
          ...
          <div class="home-container16">
            ...
            <div class="home-container17">
              ...
              <img
                ...
                class="home-image10"
              />
              <div class="home-container19"></div>
              <img
                alt="image"
                src="https://play.teleporthq.io/static/svg/placeholders/no-image.svg"
                class="home-image11"
    ...
    <section class="home-contaier">
      ...
      <div class="home-container34">
        <div class="home-container35">
          ...
          <div class="home-container37">
            <svg viewBox="0 0 987.4285714285713 1024" class="home-icon18">
              <path
      ...
      <div class="home-container39">
        ...
        <div class="home-container41">
          <div class="home-container42"></div>
          <div class="home-container43">
            <svg viewBox="0 0 1152 1024" class="home-icon20">
              <path
